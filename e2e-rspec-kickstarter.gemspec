...
Gem::Specification.new do |gem|
  ...
  gem.licenses      = ["MIT"]
  gem.description   = %q{e2e-rspec-kickstarter generates simple tests against remote server.}
  gem.summary       = %q{e2e-rspec-kickstarter generates simple tests against remote server.}
